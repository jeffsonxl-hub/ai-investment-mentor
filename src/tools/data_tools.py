...
def register_data_tools(registry, provider: "DataProvider") -> None:
    registry.register(Tool(
        ...
        func=lambda symbol,end_date,start_date=None,**kw: provider.get_index_data(start_date or "2020-01-01",end_date),
        category="data",
    ))
    registry.register(Tool(
    ...
    registry.register(Tool(
        ...
        func=lambda stock_code,end_date,start_date=None,**kw: provider.get_index_data(start_date or "2020-01-01",end_date),
        category="data",
    ))
    registry.register(Tool(
        name="fetch_news",
