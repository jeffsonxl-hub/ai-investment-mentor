...
def create_tool_registry(
    provider: "DataProvider", memory: "MemoryRepository", llm_client=None
) -> ToolRegistry:  # noqa: E501
    ...
    _inject(
        registry,
        llm_client,
        ["summarize_article", "classify_sentiment", "extract_keywords", "classify_event_type"],
    )  # noqa: E501
